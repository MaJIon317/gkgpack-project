...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal7c77957f192c8a2b4a70a19cf12e7282 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7c77957f192c8a2b4a70a19cf12e7282 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.text','data' => ['name' => 'barcode','wire:model' => 'barcode','label' => ''.e(__('Barcode')).'','placeholder' => ''.e(__('Enter the barcode')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('fields.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'barcode','wire:model' => 'barcode','label' => ''.e(__('Barcode')).'','placeholder' => ''.e(__('Enter the barcode')).'','required' => true]); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4100704437-0', $__slots ?? [], get_defined_vars());
...
<script>
    ...
    <?php
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
<?php /**PATH /var/www/gkgpack.su/public_html/resources/views/products/form.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form','data' => ['submit' => ''.e($warehouseMoving ? 'update' : 'store').'','class' => 'col-span-5 xl:col-span-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['submit' => ''.e($warehouseMoving ? 'update' : 'store').'','class' => 'col-span-5 xl:col-span-3']); ?>

     <?php $__env->slot('title', null, []); ?> 
        <?php echo e($warehouseMoving ? __('Edit warehouse moving') : __('Create warehouse moving')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.select','data' => ['label' => ''.e(__('From the warehouse')).'','wire:model' => 'from_warehouse_id','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('From the warehouse')).'','wire:model' => 'from_warehouse_id','required' => true]); ?>

                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($warehouse->id); ?>" <?php echo e($from_warehouse_id == $warehouse->id  ? 'selected' : ''); ?>><?php echo e(__($warehouse->name)); ?></option>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal8c6fd75be2f5a2dc6020af3437ea9a1f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c6fd75be2f5a2dc6020af3437ea9a1f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.select','data' => ['label' => ''.e(__('	To the warehouse')).'','wire:model' => 'to_warehouse_id','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('fields.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('	To the warehouse')).'','wire:model' => 'to_warehouse_id','required' => true]); ?>

                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($warehouse->id); ?>" <?php echo e($to_warehouse_id == $warehouse->id  ? 'selected' : ''); ?>><?php echo e(__($warehouse->name)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8c6fd75be2f5a2dc6020af3437ea9a1f)): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4090196149-0', $__slots ?? [], get_defined_vars());
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'th','class' => 'min-w-[100px]']); ?><?php echo e(__('Remains (from the warehouse)')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald58f98f716253ea4bac9f7de75949421)): ?>
<?php $attributes = $__attributesOriginald58f98f716253ea4bac9f7de75949421; ?>
<?php unset($__attributesOriginald58f98f716253ea4bac9f7de75949421); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'th','class' => 'min-w-[100px]']); ?><?php echo e(__('Remains (to the warehouse)')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald58f98f716253ea4bac9f7de75949421)): ?>
<?php $attributes = $__attributesOriginald58f98f716253ea4bac9f7de75949421; ?>
<?php unset($__attributesOriginald58f98f716253ea4bac9f7de75949421); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e($product->stocks()->where('warehouse_id', $from_warehouse_id)->where(function ($query) use ($warehouseMoving) {
                                if ($warehouseMoving) {
                                    $query->whereNot('warehouse_moving_id', $warehouseMoving->id)
                                        ->orWhere('warehouse_moving_id', null);
                                }
                            })->sum('qty')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e($product->stocks()->where('warehouse_id', $to_warehouse_id)->where(function ($query) use ($warehouseMoving) {
                                if ($warehouseMoving) {
                                    $query->whereNot('warehouse_moving_id', $warehouseMoving->id)
                                        ->orWhere('warehouse_moving_id', null);
                                }
...
<?php endif; ?>
<?php /**PATH /var/www/gkgpack.su/public_html/resources/views/warehouse-movings/form.blade.php ENDPATH**/ ?>
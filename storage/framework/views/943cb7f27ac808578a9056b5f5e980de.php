<?php if(count($this->selected) > 0): ?>
    <div class="w-full" wire:key="<?php echo e($this->getId()); ?>-selection" wire:loading.remove>
        <div
            ...
            <span>
                <?php echo app('translator')->choice('Selected 1 record|Selected :value records', count($this->selected), ['value' => count($this->selected)]); ?>
            </span>
...
<?php endif; ?>
<?php /**PATH /home/ubuntu/work/ruslan-laravel/vendor/ramonrietdijk/livewire-tables/resources/views/bar/selection.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.select','data' => ['classBlock' => '','wire:model.change' => 'subject']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['classBlock' => '','wire:model.change' => 'subject']); ?>

                    <option value=""><?php echo e(__('Subject')); ?></option>
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->subject); ?>"><?php echo e(__(ucfirst(str_replace('_', ' ', $value->subject)))); ?></option>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__(ucfirst(str_replace('_', ' ', $activity->subject)))); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald58f98f716253ea4bac9f7de75949421)): ?>
<?php $attributes = $__attributesOriginald58f98f716253ea4bac9f7de75949421; ?>
<?php unset($__attributesOriginald58f98f716253ea4bac9f7de75949421); ?>
...
<?php $component->withAttributes([]); ?>
                    <div class="flex flex-wrap gap-1">
                        <?php $__currentLoopData = $activity->object; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/gkgpack.su/public_html/resources/views/user-activity.blade.php ENDPATH**/ ?>
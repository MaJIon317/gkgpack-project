...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form','data' => ['submit' => ''.e($warehouseReduce ? 'update' : 'store').'','class' => 'col-span-5 xl:col-span-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['submit' => ''.e($warehouseReduce ? 'update' : 'store').'','class' => 'col-span-5 xl:col-span-3']); ?>

     <?php $__env->slot('title', null, []); ?> 
        <?php echo e($warehouseReduce ? __('Edit warehouse reduce') : __('Create warehouse reduce')); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1325007047-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e($product->stocks()->where('warehouse_id', $warehouse_id)->where(function ($query) use ($warehouseReduce) {
                                if ($warehouseReduce) {
                                    $query->whereNot('warehouse_reduce_id', $warehouseReduce->id)
                                        ->orWhere('warehouse_reduce_id', null);
                                }
                            })->sum('qty')); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1325007047-1', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /home/ubuntu/work/ruslan-laravel/resources/views/warehouse-reduces/form.blade.php ENDPATH**/ ?>
<div>
    <div class="bg-white border-b-2 border-indigo-500 px-7 py-4">
        <h3 class="font-medium text-black"><?php echo e($order ? __('Edit order, :name', ['name' => $order->name]) : __('Create order')); ?></h3>
    </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1668377916-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1668377916-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /var/www/gkgpack.su/public_html/resources/views/orders/form.blade.php ENDPATH**/ ?>